...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.menu_btn = CTkButton(self, text="≡", font=('arial', 24), width=30, fg_color="#1c1c1c", command=self.toggle_menu)
    ...
    def toggle_menu(self):
        if self.is_showMenu:
            ...
            self.show_menu()
            # menu widgets
            self.label = CTkLabel(self.menu_frame, text="Name", font=('arial', 24), fg_color="#151515")
